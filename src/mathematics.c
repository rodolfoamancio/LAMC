 ...
 * Name       | LimMinMax
 * ---------------------------------------------------------------------------------------------------------------
 * Function   | Compares a given value against a minimum and maximum value and returns the checked value.
 * Parameters |
 *              - val: The value to be checked against the minimum and maximum values.
 ...
 * --------------------------------------------------------------------------------------------------------------- 
 * Function   | Generates a random integer within a specified interval.
 * Parameters |
 *              - lower: The lower bound of the interval.
 *              - upper: The upper bound of the interval.
 * Returns    | The generated random integer within the specified interval.
 * **************************************************************************************************************/
 ...
 * --------------------------------------------------------------------------------------------------------------- 
 * Function   | Generates a random number following a Gaussian distribution.
 * Parameters | None.
 ...
 * Name       | Metropolis
 * --------------------------------------------------------------------------------------------------------------- 
 * Function   | Determines whether a movement should be accepted using the Metropolis algorithm based on a given 
 *              probability ratio.
 * Parameters | ProbabilityRatio: The probability ratio used to determine whether the movement is accepted.
